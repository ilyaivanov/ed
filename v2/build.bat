...
set libs=-lkernel32 -luser32 -lgdi32.lib -ldwmapi.lib -lopengl32.lib -lwinmm.lib -lopengl32.lib -lgdi32.lib 

clang typ.cpp -g -o main.exe %libs%
rem clang typ.cpp -O3 -ffast-math -o main.exe %libs%
